...
public class TipoAMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[]
            activities={"TipoAInsertarActivity","TipoAEliminarActivity","TipoAConsultarActivity",
            "TipoAActualizarActivity"};
    @Override
