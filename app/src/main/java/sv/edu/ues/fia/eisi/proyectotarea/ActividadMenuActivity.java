...
public class ActividadMenuActivity extends ListActivity {
    ...
    String[] activities={"ActividadInsertarActivity","ActividadEliminarActivity","ActividadConsultarActivity",
            "ActividadActualizarActivity"};
    @Override
    ...
    protected void onListItemClick(ListView l,View v,int position,long id){
        ...
        l.getChildAt(position).setBackgroundColor(Color.rgb(100, 100, 200));
        try{
