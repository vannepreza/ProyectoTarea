...
public class PensumMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro", "Actualizar Registro"};
    String[] activities={"PensumInsertarActivity","PensumEliminarActivity","PensumConsultarActivity", "PensumActualizarActivity"};
    @Override
